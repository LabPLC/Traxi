...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFooterColor = res.getColor(R.color.generic_amarillo);
        ...
        final int defaultSelectedColor = res.getColor(R.color.rojo_logo);
        final boolean defaultSelectedBold = res.getBoolean(R.bool.default_title_indicator_selected_bold);
        final int defaultTextColor = res.getColor(R.color.generic_rojo_alfa);
        ...
        mPaintText.setTypeface(new fonts(context.getApplicationContext()).getTypeFace(fonts.FLAG_ROJO));
